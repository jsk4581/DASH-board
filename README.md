...
- **Highlight reminders** (Android app) — a notification listing the highlighted items, repeated on a schedule you set (every 30 minutes to once a day) outside your quiet hours
