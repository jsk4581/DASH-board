...
- **Big 3**: the Daily card's "Add item" opens a list of every item; tick up to three, and the trash on a pinned row unpins it. The Monthly and Yearly cards add a blank row of their own instead
