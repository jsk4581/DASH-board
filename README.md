...
A **lightweight, no-nonsense** personal schedule dashboard — like moving your
paper to‑do list straight onto the web.
...
> The UI ships in **Korean and English** — toggle with the 🌐 button in the toolbar.
