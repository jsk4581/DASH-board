...
const dict = {
  ko: {
    ...
    mergeOpen: '차이 보고 합치기',
    mergeTitle: '동기화 충돌',
    mergeIntro: '마지막 동기화 이후 양쪽이 같은 것을 다르게 고쳤습니다. 겹치지 않는 변경은 자동으로 합쳐지고, 겹치는 것만 고르면 됩니다.',
    ...
    mergeAllNewest: '최신 쪽으로',
    mergeAllNewestHint: '충돌마다 나중에 고친 쪽을 고릅니다. 한쪽에서 지운 것은 남깁니다.',
    ...
    doneTab: '완료 내역',
    big3: 'Daily Big 3',
    big3Month: 'Monthly Big 3',
    big3Year: 'Yearly Big 3',
    ...
    diaryTab: '다이어리',
    diaryFuture: '나의 미래',
    diaryMotivation: '내적동기',
    diaryGratitude: '감사일기',
    diaryIdentity: '정체성',
    diaryMorning: '기상직후 할일',
    diaryFeedback: '오늘의 피드백',
    diaryPhFuture: '내가 그리는 미래는…',
    diaryPhMotivation: '내가 이 일을 하는 이유는…',
    diaryPhGratitude: '오늘 감사한 것은…',
    diaryPhIdentity: '나는 …한 사람이다',
    diaryPhMorning: '눈 뜨자마자 할 일은…',
    diaryPhFeedback: '오늘 잘한 것과 아쉬운 것은…',
    diaryToday: '오늘',
    diaryYesterday: '어제',
    diaryDaysAgo: '{n}일 전',
    diaryDays: '하루 한 장',
    ...
    remindTitle: '알림 설정',
    remindOn: '할 일 알림 받기',
    diaryRemindOn: '다이어리 알림 받기',
    diaryNotifTitle: '다이어리 쓸 시간',
    diaryNotifBody: '오늘의 피드백, 감사일기, 기상직후 할일을 적어 보세요.',
    ...
    remindInexact: '정확한 시각 알림이 꺼져 있어 알림이 늦게 올 수 있습니다.',
    remindInexactFix: '알람 및 리마인더 허용',
    remindHint: '알림은 정한 시각에 옵니다. 할 일 알림은 고른 항목이 없으면 오지 않고, 내용은 앱을 열 때마다 새로 반영됩니다.',
  ...
  en: {
    ...
    highlight: 'Important',
    urgent: 'Urgent',
    unstar: 'Clear the star',
    toggleHighlight: 'Important, then urgent, then off',
    due: 'Due date',
    setDue: 'Set due date',
    delete: 'Delete',
    ...
    mergeAllNewest: 'Newest wins',
    mergeAllNewestHint: 'For each conflict, take the side that edited it last; something deleted on one side is kept.',
    ...
    // diary tab
    diaryTab: 'Diary',
    diaryFuture: 'My future',
    diaryMotivation: 'Inner motivation',
    diaryGratitude: 'Gratitude',
    diaryIdentity: 'Identity',
    diaryMorning: 'Right after waking',
    diaryFeedback: "Today's feedback",
    diaryPhFuture: 'The future I picture is…',
    diaryPhMotivation: 'I do this because…',
    diaryPhGratitude: 'Today I am grateful for…',
    diaryPhIdentity: 'I am someone who…',
    diaryPhMorning: 'The first things after waking…',
    diaryPhFeedback: 'What went well today, what did not…',
    diaryToday: 'Today',
    diaryYesterday: 'Yesterday',
    diaryDaysAgo: '{n} days ago',
    ...
    remindOn: 'Item reminders',
    diaryRemindOn: 'Diary reminder',
    diaryNotifTitle: 'Time to write your diary',
    diaryNotifBody: "Today's feedback, gratitude, and what comes right after waking.",
    ...
    remindInexact: 'Exact alarms are off for DASH, so reminders may arrive late.',
    remindInexactFix: 'Allow alarms & reminders',
    remindHint: 'Each reminder arrives at its time. Item reminders are not sent while no item is picked, and their content refreshes every time you open the app.',
