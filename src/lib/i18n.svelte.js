...
const dict = {
  ko: {
    ...
    remindHint: '알림은 정한 시각부터 한 시간 안에 도착합니다. 할 일 알림은 고른 항목이 없으면 오지 않고, 내용은 앱을 열 때마다 새로 반영됩니다.',
  ...
  en: {
    ...
    remindHint: 'Each reminder arrives within an hour of its time. Item reminders are not sent while no item is picked, and their content refreshes every time you open the app.',
