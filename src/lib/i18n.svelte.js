...
const dict = {
  ko: {
    ...
    remindChannelDesc: '빨간 동그라미로 강조한 항목을 정해 둔 주기로 알려 줍니다.',
  ...
  en: {
    ...
    remindOn: 'Remind me',
    remindEvery: 'Repeat',
    remindQuiet: 'Quiet hours',
    remindTimes: 'Reminder times',
    remindOff: 'Reminders off',
    remindAllDay: 'all day',
    ...
    remindChannelDesc: 'Items you circled in red, repeated on your schedule.',
    remindNotifTitle: '{n} highlighted',
    remindMore: '+{n} more',
    every30: 'Every 30 min',
    every60: 'Every hour',
    every120: 'Every 2 hours',
    every180: 'Every 3 hours',
    every240: 'Every 4 hours',
    every360: 'Every 6 hours',
    every720: 'Every 12 hours',
    every1440: 'Once a day',
